    ...
    def forward(self, student_output, teacher_outputs,target):
        ...
        if self.logit_criterion == 'CE':
            ...
            logit_loss = F.kl_div(
                ...
                reduction='batchmean',
                log_target=True
            ) * self.logit_criterion_weight 

        else:
            raise NotImplementedError


        total_loss = action_loss + logit_loss 
        return  total_loss, \
                action_logit, \
...
def get_args():
    ...
    #DISENTANGLE
    parser.add_argument('--logit_criterion', default='KL', choices=['KL', 'CE'], type=str)
    ...
    parser.add_argument('--data_path', default='/path/to/list_kinetics-400', type=str,
                        help='dataset path')
    parser.add_argument('--data_prefix', default='data/Kinetics-400', type=str)
    ...
    parser.add_argument('--data_set', default='Kinetics-400', choices=['Diving-48', 'Kinetics-400', "UCF101-HAT", "Kinetics-HAT", "Kinetics-BG", "UCF101-BG", 'SSV2', 'UCF101', 'HMDB51', 'image_folder'],
