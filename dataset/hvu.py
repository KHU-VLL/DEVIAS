...
class VideoClsDataset_HVU(Dataset):
    ...
    def __init__(self, anno_path, data_path, mode='train', clip_len=8,
        ...
        self.dataset_samples = [os.path.join(self.data_path, i) + '.mp4' for i in cleaned.values[:, 0]]
        self.action_label_array = list(cleaned.values[:, 1])
        self.scene_label_array = list(cleaned.values[:, -1])
    ...
    def __getitem__(self, index):
        if self.mode == 'train':
            ...
            return buffer, self.action_label_array[index], self.scene_label_array[index], index, index
